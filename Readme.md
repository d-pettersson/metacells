...
[[https://github.com/d-pettersson/serialCore/blob/master/Preview.jpg|alt=Preview]]
...
3. Clone this repo
  ...
  ```
4. Enter the `serialCore` folder and start the project by clicking on `serialCore.toe`
